...
class BiSRNet(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        return F.interpolate(change, size=x_size[2:], mode='bilinear', align_corners=False),F.interpolate(out1, size=x_size[2:], mode='bilinear', align_corners=False),F.interpolate(out2, size=x_size[2:], mode='bilinear', align_corners=False)
